...
func createProvisioningSrvSutFromEnv(t *testing.T, env *testEnvironment) ProvisioningSrv {
	...
	return ProvisioningSrv{
		...
		contactPointService: provisioning.NewContactPointService(ac.NewReceiverAccess[*models.Receiver](env.ac, true), configStore, env.secrets, env.prov, env.xact, receiverSvc, env.log, env.store, ngalertfakes.NewFakeReceiverPermissionsService()),
